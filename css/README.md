...
![conceptos](./imagen/grid-css-conceptos.png).
...
- **grid-template-columns:** Establece las columna.
- **grid-template-rows:** Establece las filas.
...
![template-columns](./imagen/grid-template-columns.png)
...
![rid-unidades](./imagen/grid-unidad-fr.png)
...
![grid_lineas](./imagen/grid-linenames.png)
...
![grid-zone](./imagen/grid-linenames-zones.png)
...
![grid-template-areas](./imagen/grid-template-areas.png)
...
- **row-gap:** Establece espacio entre filas.
...
```
- **OJO:** Antiguamente, las propiedades column-gap, row-gap y gap eran conocidas como grid-column-gap, grid-row-gap y grid-gap, por lo que aún puedes encontrar información obsoleta que las mencione. Hoy en día deberías utilizar las tres primeras en su lugar.
...
1. justify-items: start | end | center | stretch : Distribuye los elementos en el eje horizontal.
   
2. align-items: start | end | center | stretch : Distribuye los elementos en el eje vertical.
...
1. place-items: [align-items] [justify-items] : Propiedad de atajo para *-items*.
   
2. place-content: [align-content] [justify-content] : Propiedad de atajo para *-content*.
...
1. grid-auto-columns: Indica el tamaño automático de ancho que tendrán las columnas.
   
2. grid-auto-rows: Indica el tamaño automático de alto que tendrán las filas.
   
3. grid-auto-flow: row | column | dense : Utiliza un algoritmo de autocolocación (intenta rellenar huecos).
...
![grid-css-auto-flow](./imagen/grid-css-auto-flow.png)
...
1. justify-self: Altera la justificación del ítem hijo en el eje horizontal.
   
2. align-self: Altera la alineación del ítem hijo en el eje vertical.
   
3. grid-area: Indica un nombre al área especificada, para su utilización con grid-template-areas.
...
![grid-column-start-end](./imagen/grid-column-start-end.png)
...
![grid-column-start-end-2](./imagen/grid-column-start-end-2.png)
...
![grid-column-start-end-3](./imagen/grid-column-start-end-3.png)
